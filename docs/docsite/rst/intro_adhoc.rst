...
.. note::
   The :ref:`command <command>` module does not support extended shell syntax like piping and redirects (although
...
Using the :ref:`shell <command>` module looks like this::
